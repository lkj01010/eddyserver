...
public class SVNMenuItems : ScriptableObject
{
    ...
    [MenuItem("SVN/" + SVNTerminoligy.delete)]
    public static void SVNDeleteOnSelected()
    {
        SVNCommands.instance.SVNDelete(GetAssetPathsOfSelected().ToArray());
    }

    [MenuItem("Assets/SVN/" + SVNTerminoligy.delete)]
    public static void SVNDeleteProjectContext()
    {
        SVNCommands.instance.SVNDelete(GetAssetPathsOfSelected().ToArray());
    }
